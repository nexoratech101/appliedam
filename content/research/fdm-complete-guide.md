...
categories: ["Research"]
tags: ["FDM", "3D Printing", "Materials", "Beginners", "Engineering"]
draft: false
---
...
| Material | Temp (C) | Strength | Best For |
|---|---|---|---|
| PLA | 190-220 | Moderate | Prototypes, visual models |
| PETG | 230-250 | Good | Functional parts |
| ABS | 220-250 | Good | Heat resistance |
| Nylon | 240-270 | Excellent | Load-bearing parts |
| TPU | 220-240 | Flexible | Gaskets, grips |
...
|---|---|---|
| Layer separation | Temp too low | Increase by 5C |
| Stringing | Retraction too low | Increase retraction |
| Warping | Poor bed adhesion | Clean bed, use brim |
| Under-extrusion | Partial clog | Cold pull nozzle |

---

*Have a project using FDM? [Submit it to AppliedAM](/submit/)*